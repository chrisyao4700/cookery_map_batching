...
class CMAddress extends ODInstance {

    constructor(address_token, address_id) {
        super('cm_address', 'address_token', address_token, address_id);
    }
    ...
    async registerAddress(address_info = {}) {
        ...
        try {
            ...
            // const addr_record = await CMAddress._findAddressWithAddressStr(address_str);
            //
            ...
            this.instance_id = await this.insertInstance(
                {
                    ...
                    city: city || '', state: state, zip: zip || 'N/A', cdate: 'now()', udate: 'now()', status: 0,
                    lat, lng
                });
